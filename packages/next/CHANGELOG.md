...
- 4ddfa26: Introduce the **@kevincii/http-query ecosystem** — a type-safe, QUERY-first toolkit for complex API reads.
...
- Updated dependencies [4ddfa26]
  - @kevincii/http-query-core@0.3.0
  - @kevincii/http-query-react@0.3.0
